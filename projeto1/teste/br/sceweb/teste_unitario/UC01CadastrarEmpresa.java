...
/**
 * Este script de teste verifica o comportamento do caso de uso
 * UC01CadastrarEmpresa
 * 
 * @author professor
 *
 */
public class UC01CadastrarEmpresa {
	...
	@Test
	public void CT04UC01FBCadastra_nome_invalido() {
		empresaDAO = new EmpresaDAO(configuraDB);
//		empresaDAO.adiciona(empresa);
		assertEquals("Nome invalido", empresa.setNomeDaEmpresa(""));
	}
	
	@Test
	public void CT05UC01FBCadastra_Telefone() {
		empresaDAO = new EmpresaDAO(configuraDB);
//		empresaDAO.adiciona(empresa);
