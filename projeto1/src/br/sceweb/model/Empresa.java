...
public class Empresa {
	...
	public boolean isNomeValido(String nomeDaEmpresa){
	...
	public boolean isTelefoneValido(String telefoneDaEmpresa){
		if(telefoneDaEmpresa.equals("")){
			return false;
		}
		return true;
	}
